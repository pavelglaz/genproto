...
export default class TsCommandBuilder extends CommandBuilder {
    ...
    private tsPluginLocations = [
        ...
        './node_modules/@pavelglaz/genproto/node_modules/ts-proto/protoc-gen-ts_proto',
    ]
    ...
    async protocCommand(): Promise<string[]> {
        ...
        switch (projectPlatform) {
            ...
            case Platform.ts: {
                typesProtoPath = './node_modules/@pavelglaz/types/dist/proto/'
                typesSubPaths = ['dist', 'proto', '@pavelglaz', 'types']
                dependenciesPattern = 'node_modules/@pavelglaz/**/proto/**/*.proto'
                break
            }
        }
